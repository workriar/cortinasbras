                    ...
                    >
                        ...
                        <div className="relative aspect-video">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-8">
                                <div className="text-white">
                                    <h3 className="text-2xl font-extrabold mb-2">Oferta de Inauguração Online!</h3>
                                    <p className="text-brand-300 font-bold">15% OFF em toda linha sob medida</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-8">
                            <p className="text-brand-700/70 mb-6">
                                Aproveite nossa promoção exclusiva para solicitações feitas através do novo site. Qualidade Brás com o melhor preço de São Paulo.
                            </p>
                            <button
                                onClick={close}
