...
const products = [
    {
        ...
        icon: Home,
        features: ["Entrega imediata", "Várias cores", "Fácil instalação"],
        delay: 0.1,
    },
    {
        ...
        icon: Scissors,
        features: ["Tecidos nobres", "Acabamento Wave", "Trilho Suíço"],
        delay: 0.2,
    },
    {
        ...
        icon: Bed,
        features: ["Algodão Nobre", "Design Exclusivo", "Toque Macio"],
        delay: 0.3,
    },
];
        ...
        <section id="produtos" className="py-24 bg-white relative overflow-hidden">
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    >
                        Combinamos artesanato tradicional com design contemporâneo para criar cortinas e enxovais que contam histórias.
                    </motion.p>
                </div>
