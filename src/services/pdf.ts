    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            doc.fillColor(COLOR_GOLD)
                .fontSize(24)
                .text("CORTINAS BRÁS", { align: "center" })
                .moveDown(0.3);

            doc.fillColor(COLOR_GOLD)
                .fontSize(18)
                .text("ORÇAMENTO PERSONALIZADO", { align: "center" })
                .moveDown(0.5);

            doc.fillColor(COLOR_GRAY)
                .fontSize(10)
                .text(`ID: #${lead.id} | Gerado em: ${new Date().toLocaleString("pt-BR")}`, { align: "center" })
                .moveDown(2);
            ...
            doc.fillColor(COLOR_BLACK)
                ...
                .text(`Instalação: ${lead.instalacao || "Sim"}`)
                .moveDown(1.5);
            ...
            doc.fillColor(COLOR_GRAY)
                .fontSize(10)
                .text("Cortinas Brás - Tradição e Qualidade desde 2003", { align: "center" })
                .text("Av. Celso Garcia, 129 - Brás, São Paulo - SP, 03015-000 | (11) 99289-1070", { align: "center" })
                .fontSize(8)
                .text("Este orçamento é uma estimativa e pode sofrer alterações após visita técnica.", { align: "center" });
